    ...
    <div class="full price_table padding_infor_info">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <form method="POST" action="<?php echo base_url('matrice/Users/affecter') ?>"
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <input type="text" readonly="" class="form-control" name="User" value="<?=$user['mbr_fname'].' '.$user['mbr_lname'] ?>">
              </div>
              <div class="col-md-6">
                ...
                <div class="card">
                  <div class="card-body">
                    <?php 
                      foreach ($bureaux as $key) { ?>
                       <div class="col-md-6">
                         <input type="checkbox" name="bureau_id[]" value="<?=$key['bureau_id'] ?>"> <?=$key['bureau_descr'] ?>
                       </div>
                    <?php  }
