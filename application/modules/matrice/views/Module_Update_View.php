  ...
  <div id="main-wrapper">
    ...
    <div class="full price_table padding_infor_info">
      ...
      <div class="row">
        <div class="col-lg-12">
         <div class="table">
          <form id="form_new" method="post" action="<?=base_url('matrice/Module/update')?>">
                <input type="hidden" value="<?=$data['ID_MODULE']?>" name="id" >
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" name="MOTCLE" id="MOTCLE"  value="<?=$data['MOT_CLE']?>" class="form-control">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <input type="text" name="ICONE" id="ICONE"  value="<?=$data['ICONE']?>" class="form-control">
                    <span class="text-danger"><?php echo form_error("ICONE");?></span>
                  </div>

                  <div class="col-md-6">
                    <span class="label-input100"><b>Controller</b></span>
                    <input type="text" name="CONTROLLER" id="CONTROLLER"  value="<?=$data['CONTROLLER']?>" class="form-control">
                  </div>
                </div>
