          ...
          <div class="col-sm-12 p-md-0">
            ...
            <div class="row">
              <div class="welcome-text col-lg-6">
                <h2 style='color:#007bac'>Liste des appartements</h2>
               </div>
              <div class="col-lg-6">

                <ul class="nav nav-pills nav-fill justify-content-around rounded shadow m-4">
                  <li class="nav-item"><a class="nav-link <?php if(in_array($this->router->method,['insert'])) echo 'active';?>"  href="<?=base_url('appartement/Appartement/Add/')?>"><i class="fa fa-pencil-square-o"></i>Nouveau</a></li>
...
<script>
  ...
  function liste()
  {
   ...
   table=$("#mytable").DataTable({
    ...
    "oreder":[[ 0, 'desc' ]],
    "ajax":{
      url:"<?=base_url()?>appartement/Appartement/listing/",
      type:"POST"
    },
