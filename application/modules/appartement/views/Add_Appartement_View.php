            ...
            <form id="form_new"  enctype="multipart/form-data" method="post" action="<?=base_url('appartement/Appartement/ajouter')?>" >
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="file" name="IMAGE_MEUBLE" id="IMAGE_MEUBLE"  value="<?=set_value('IMAGE_MEUBLE');?>" class="form-control">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" name="NOM_MEUBLE" id="NOM_MEUBLE"  value="<?=set_value('NOM_MEUBLE');?>" class="form-control">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" name="NUMERO_MEUBLE" id="NUMERO_MEUBLE"  value="<?=set_value('NUMERO_MEUBLE');?>" class="form-control">
