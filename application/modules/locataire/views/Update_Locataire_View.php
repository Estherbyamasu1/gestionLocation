      ...
      <div class="container-fluid">
        <div class="row page-titles mx-0">
          <div class="col-sm-12 p-md-0">
            ...
            <div class="row">
              <div class="col-lg-6">
                <!-- <div class="heading1 mt-4 ml-5"> -->
                  <h2>Modification des locataires</h2>
                <!-- </div> -->
              </div>
            ...
            <form id="form_new"  enctype="multipart/form-data" method="post" action="<?=base_url('locataire/Locataire/update')?>" >
              


                <input type="hidden" name="ID_LOCATAIRE" id="ID_LOCATAIRE" class="form-control" value="<?php echo $locataire['ID_LOCATAIRE']?>" >
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" name="NOM_LOCATAIRE" id="NOM_LOCATAIRE"  value="<?php echo $locataire['NOM_LOCATAIRE']?>" class="form-control">
                  ...
                  <div class="col-md-6">
                    <span class="label-input100"><b>Prénom</b><font color="red" >*</font></span>
                    <input type="text" name="PRENOM_LOCATAIRE" id="PRENOM_LOCATAIRE"  value="<?php echo $locataire['PRENOM_LOCATAIRE']?>" class="form-control">
                    <span class="text-danger"><?php echo form_error("PRENOM_LOCATAIRE");?></span>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <span class="label-input100"><b>Téléphone</b><font color="red" >*</font></span>
                    <input type="number" name="TELEPHONE" id="TELEPHONE"  value="<?php echo $locataire['TELEPHONE']?>" class="form-control">
                    <span class="text-danger"><?php echo form_error("TELEPHONE");?></span>
                  </div>
                  <div class="col-md-6">
                    <span class="label-input100"><b>Email</b></span>
                    <input type="email" name="EMAIL" id="EMAIL"  value="<?php echo $locataire['EMAIL']?>" class="form-control">
