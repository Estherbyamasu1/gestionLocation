            ...
            <!-- <?=$this->lang->line('carrousel_process_home_2')?></p> -->
                    ...
                    <div class="container">
                      <div class="text-center wow fadeInUp">
                        <h3 class="section-subtitle">Formulaire d'inscription pour la reservation</h3>
                      </div>
                      <br>
                      <br>
                      <form enctype="multipart/form-data" method="post" action="<?=base_url('Inscription_Locataire/ajouter')?>">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <span class="label-input100"><b>Email</b><font color="red" >*</font></span>
                      ...
                      <div class="row">
                       <div class="col-md-6">
                        <span class="label-input100"><b>Genre</b><font color="red" >*</font></span>
                        <select name="ID_SEXE" id="ID_SEXE"  class="form-control">
                          ...
                          {
                            ?>
                            <option value="<?=$value['ID_SEXE']?>"><?=$value['DESC_SEXE']?></option>
                            <?php
                          }
                          ?>
                        </select>
                        <span class="text-danger"><?php echo form_error("ID_SEXE");?></span>
                        <?php
                        if ($this->session->has_userdata('dash')) {
                          echo '<div class="' . $this->session->dash['class'] . '" role="alert">' . $this->session->dash['message'] . '</div>';
                        }
                      ...
                      <div class="col-md-6">
                        <span class="label-input100"><b>Adresse actuelle</b><font color="red" >*</font></span>
                        <input type="text" name="ADRESSE_ACTUELLE" id="ADRESSE_ACTUELLE"  value="<?=set_value('ADRESSE_ACTUELLE');?>" class="form-control">
                        <span class="text-danger"><?php echo form_error("ADRESSE_ACTUELLE");?></span>
                      </div>
                    </div>
