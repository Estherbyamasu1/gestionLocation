                      ...
                      <form action="<?= base_url('Login/do_login')?>" method="post">
                        <fieldset>
                           <div class="form-group col-lg-12">
                                    ...
                                    <input type="text" name="username" class="form-control" placeholder="Adresse e-mail">
                                    <font color="red" class="help"><?php echo form_error('username'); ?></font>
                                </div>
                                <div class="form-group col-lg-12">
                                    <label style="font-weight: 900; color:#454545">Mot de passe</label>
                                    <input type="password" id="pwd" name="password" class="form-control" placeholder="Mot de passe">
